...
//
//  Created by Pradeep Gianchandani on 18/01/21.
//
...
class SwipingPhotosController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    init(isCardViewMode: Bool = false) {
        ...
        super.init(transitionStyle: .scroll, navigationOrientation: .horizontal) //page curl is the default style
    }
...
//        barsStackview.anchor(top: view.safeAreaLayoutGuide.topAnchor, leading: view.leadingAnchor, bottom: nil, trailing: view.trailingAnchor, padding: .init(top: 8, left: 8, bottom: 0, right: 8), size: .init(width: 0, height: 4))
    ...
    override func viewWillLayoutSubviews() {
        ...
        //paddingTop variable is added instead of adding padding from top safe area because scrolling down was resulting in blinking effect of horizontal bars
        if #available(iOS 13.0, *) {
            var paddingTop: CGFloat = 8
...
class PhotoController: UIViewController {
    ...
    let imageView = UIImageView(image: #imageLiteral(resourceName: "pc1"))
    ...
    override func viewDidLoad() {
        ...
        imageView.clipsToBounds = true //this property is set to true so that bigger image height dont overlap its superview
    }
}
