...
class UserDetailsController: UIViewController, UIScrollViewDelegate {
    ...
    lazy var scrollView: UIScrollView = {
        ...
        //This will keep the scrollview underneath the top safe area
    ...
    // This is added to avoid photo getting cropped from the top
    // This will help in avoiding cropping of faces from the top
    fileprivate let extraSwipingHeight: CGFloat = 80
    
    // we set the frame of swiping photos view in this method because scroll view doesnt know its exact frame in viewdidload method
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        // Here we are shifting the y-value upwards and x-value leftside
